...
def test_should_be_return_values(books_model) -> None:
    assert books_model.__repr__().__eq__('<BooksModel(isbn=None, book_name=None, author=None, co_author=None, publishing_company=None, area=None, shelf=None, included_at=None, updated_at=None)>')
